...
async function seed() {
  try {
    ...
    // Create historical energy generation records from Aug 1, 2025 8pm to Dec 29, 2025 6pm (Sri Lanka time) every 2 hours
    const records = [];
    const startDate = new Date("2025-08-01T08:00:00Z"); // August 1, 2025 8pm UTC
    const endDate = new Date("2025-12-29T12:30:00Z"); // December 29, 2025 12:30pm UTC (6:00pm Sri Lanka time)
    ...
    console.log(
      `Database seeded successfully. Generated ${recordCount} energy generation records from August 1, 2025 8pm to December 29, 2025 6pm (Sri Lanka time).`
    );
  } catch (err) {
