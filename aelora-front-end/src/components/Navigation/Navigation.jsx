const Navigation = () => {
    ...
    /**
     * Only JSX expressions are allowed in return statement => js code that evaluates to values
    ...
    return (
        <nav className={"px-12 py-6 flex justify-between items-center"}>
            ...
            <div className={"flex items-center gap-12"}>
                <div className={"flex item-center gap-3 px-3 py-2"}>
                    <svg 
                        xmlns="http://www.w3.org/2000/svg" 
                        width="24" 
                        height="24" 
                ...
                <div className={"flex items-center gap-2"}>
                    <div className={"w-8 h-8 rounded-full bg-blue-400 flex justify-center items-center"}>
                        <span className="font-[Inter] text-sm font-medium text-white">{user}</span>
                    </div>
